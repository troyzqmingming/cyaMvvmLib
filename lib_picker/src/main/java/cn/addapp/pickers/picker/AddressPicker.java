...
public class AddressPicker extends LinkagePicker {
    public interface ProvinceChangeCallback{
        void onChange();
    }
    ...
    private ProvinceChangeCallback callback;
    ...
    public void setProvinceChangeCallback(ProvinceChangeCallback callback){
        this.callback = callback;
    }

    public void notifyData(ArrayList<Province> provinces){
        provider = new AddressProvider(provinces);
        this.provinces = provinces;
    }
    ...
    public static class AddressProvider implements DataProvider {
        ...
        public void parseData(List<Province> data) {
